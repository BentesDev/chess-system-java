...
public class UI {
	...
	public static PosicaoXadrez lerPosicaoXadrez(Scanner sc) {
		...
		return new PosicaoXadrez(coluna, linha);
			...
			throw new InputMismatchException("Erro lendo valor de Posição");
		}
	}
	
	public static void printPartida(PartidaXadrez chessMatch, List<PecaXadrez> capturado)  {
	...
	private static void printPeca(PecaXadrez piece, boolean fundo) {
		if(fundo) {
